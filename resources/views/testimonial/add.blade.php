                ...
                <div class="panel panel-default">
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('testimonial.create') }}" id="testimonial_form" enctype="multipart/form-data">
                        @csrf
                           <div class="row">
                           ...
                           <div class="row">
                              <div class="form-group col-md-3 col-lg-3">
                                 ...
                                 <textarea class="col-md-12" id="description" name="description" required=""></textarea>
                              </div>
                              <div class="form-group col-md-3 col-lg-3">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-3 col-lg-3">                
                                 <input type="submit" style=" margin: 7%;" class="btn btn-default" value="Add">
                              </div>
                           </div>
                        </form>
                     </div>
