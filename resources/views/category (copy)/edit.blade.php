                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('category.create') }}/edit/{{$data['id']}}" id="category_form" novalidate>
                        @csrf
                           <div class="row">
                           ...
                           <div class="row">
                                ...
                                <div class="form-group col-md-4 col-lg-4">
                                    ...
                                    <input type="text" class="col-md-12 " id="slug" name="slug" value="{{$data['slug']}}" required="required">
                                </div>
                                <div class="form-group col-md-4 col-lg-4">
                                    <label for="name" class="form-label">Menu Category Name:</label>
                                    <input type="text" class="col-md-12 " id="name" name="name" value="{{$data['name']}}" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <input type="submit" class="btn btn-default pull-left" id="addSubCategoryBtn" name="addSubCategoryBtn" value="Update">
                            </div>
                        </form>	
                     </div>
                  </div>
