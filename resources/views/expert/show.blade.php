                        ...
                        <div class="col-lg-12 col-md-12 table-responsive">
                           <div class="panel-body" style="margin-top:50px;">
                              <table id="example0" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example0_info" style="display:block;overflow:scroll;">
                                 <thead>
                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="ID: activate to sort column descending" style="width: 14px;">S. No.</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 47px;">Name</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Subject: activate to sort column ascending" style="width: 57px;">Subject</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Qualification: activate to sort column ascending" style="width: 100px;">Qualification</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Rating: activate to sort column ascending" style="width: 48px;">Rating</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Order Finished: activate to sort column ascending" style="width: 61px;">Order Finished</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Order Progress: activate to sort column ascending" style="width: 69px;">Order Progress</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Country: activate to sort column ascending" style="width: 62px;">Country</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Description: activate to sort column ascending" style="width: 117px;">Description</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Photo: activate to sort column ascending" style="width: 104px;">Photo</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Alt Tag: activate to sort column ascending" style="width: 25px;">Alt Tag</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Edit: activate to sort column ascending" style="width: 49px;">Edit</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Delete: activate to sort column ascending" style="width: 66px;">Delete</th><th class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 63px;">Status</th></tr>
                                 </thead>
                                 <tbody>
                                 @php 
                                 ...
                                 <tr id="tr1" role="row" class="odd">
                                    ...
                                    <td>{{ $val->rating }}</td>
                                    <td>{{ $val->orderfinish }}</td>
                                    <td>{{ $val->orderprogress }}</td>
                                    <td>{{ $val->country }}</td>
                                    <td>{{Str::limit($val->description, 20, $end='.......')}}</td>
                                    <td>
                                       <img src="{{ route('home') }}/public/storage/images/expert/{{ $val->image }}" style="border-radius:100%;width:120px;">
                                    </td>
                                    <td>{{ $val->imagealt }}</td>
                                    <td>
                                       <a href="{{ route('expert.create') }}/{{ $val->id }}"><input type="button" class="btn btn-primary btnedit-delete" value="Edit" name="edit" id="edit"></a></td>
                                    <td>
                                       <form method="POST" action="{{ route('expert.create') }}/{{ $val->id }}" id="expert_edit_form" enctype="multipart/form-data">
                                       @csrf
                                       @method('DELETE')
                                    ...
                                    <td>
                                       <input type="submit" class="btn btn-success" value="Active" onclick="return confirm('Are you sure you want to deactivate the expert record');" name="inactive" id="inactive">
                                    </td>        
                                 </tr>
                                 @endforeach
                                 </tbody>
