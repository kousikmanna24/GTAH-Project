                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('expert.create') }}/{{ $data['id'] }}" id="expert_edit_form" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                        ...
                        <div class="panel panel-default">
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="name" class="form-control" name="name" placeholder="Enter name" value="{{ $data['name'] }}" required="">
                              </div>
                              <div class="col-md-6">
                                 <label for="subject">Expert Subject</label>
                                 <div class="form-group">
                                    <input list="subject" class="form-control" name="subject" placeholder="Enter subject.." value="{{ $data['subject'] }}" required="">
                                    <datalist id="subject">
                                       <option value="Accounting" {{ ($data['subject'] == 'Accounting') ? 'selected' : '' }}></option>
                                       <option value="Business Law" {{ ($data['subject'] == 'Business Law') ? 'selected' : '' }}></option>
                                       <option value="Chemistry" {{ ($data['subject'] == 'Chemistry') ? 'selected' : '' }}></option>
                                       <option value="Civil Law" {{ ($data['subject'] == 'Civil Law') ? 'selected' : '' }}></option>
                                       <option value="Criminal Law" {{ ($data['subject'] == 'Criminal Law') ? 'selected' : '' }}></option>
                                       <option value="Database" {{ ($data['subject'] == 'Database') ? 'selected' : '' }}></option>
                                       <option value="Economics" {{ ($data['subject'] == 'Economics') ? 'selected' : '' }}></option>
                                       <option value="Electrical Engineering" {{ ($data['subject'] == 'Electrical Engineering') ? 'selected' : '' }}></option>
                                       <option value="Engineering" {{ ($data['subject'] == 'Engineering') ? 'selected' : '' }}></option>
                                       <option value="Finance" {{ ($data['subject'] == 'Finance') ? 'selected' : '' }}></option>
                                       <option value="Geography" {{ ($data['subject'] == 'Geography') ? 'selected' : '' }}></option>
                                       <option value="Healthcare" {{ ($data['subject'] == 'Healthcare') ? 'selected' : '' }}></option>
                                       <option value="HRM" {{ ($data['subject'] == 'HRM') ? 'selected' : '' }}></option>
                                       <option value="IT Write Up" {{ ($data['subject'] == 'IT Write Up') ? 'selected' : '' }}></option>
                                       <option value="Management" {{ ($data['subject'] == 'Management') ? 'selected' : '' }}></option>
                                       <option value="Maths" {{ ($data['subject'] == 'Maths') ? 'selected' : '' }}></option>
                                       <option value="Medical" {{ ($data['subject'] == 'Medical') ? 'selected' : '' }}></option>
                                       <option value="Migration Law" {{ ($data['subject'] == 'Migration Law') ? 'selected' : '' }}></option>
                                       <option value="Music" {{ ($data['subject'] == 'Music') ? 'selected' : '' }}></option>
                                       <option value="Networking" {{ ($data['subject'] == 'Networking') ? 'selected' : '' }}></option>
                                       <option value="Pharmacy" {{ ($data['subject'] == 'Pharmacy') ? 'selected' : '' }}></option>
                                       <option value="Physics" {{ ($data['subject'] == 'Physics') ? 'selected' : '' }}></option>
                                       <option value="Programming" {{ ($data['subject'] == 'Programming') ? 'selected' : '' }}></option>
                                       <option value="Project Management" {{ ($data['subject'] == 'Project Management') ? 'selected' : '' }}></option>
                                       <option value="Psychology" {{ ($data['subject'] == 'Psychology') ? 'selected' : '' }}></option>
                                       <option value="Statistics" {{ ($data['subject'] == 'Statistics') ? 'selected' : '' }}></option>
                                       <option value="Supply Chain" {{ ($data['subject'] == 'Supply Chain') ? 'selected' : '' }}></option>
                                       <option value="Tax" {{ ($data['subject'] == 'Tax') ? 'selected' : '' }}></option>
                                       <option value="Webpage Design" {{ ($data['subject'] == 'Webpage Design') ? 'selected' : '' }}></option>
                                    </datalist>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    <input type="text" id="orderfinish" class="form-control" name="orderfinish" placeholder="Enter order finished.." value="{{ $data['orderfinish'] }}" required="">
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    <input type="text" id="orderprogress" class="form-control" name="orderprogress" value="{{ $data['orderprogress'] }}" placeholder="Enter order progress.." required="">
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <label for="country">Country</label>
                                 <div class="form-group">
                                    <input list="country" class="form-control" name="country" placeholder="Enter country.." value="{{ $data['country'] }}" required="">
                                    <datalist id="country">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    <textarea cols="5" rows="5" class="form-control" name="description" placeholder="Type description here.." id="description" required="">{{ $data['description'] }}</textarea>
                                 </div>
                              </div>
                              <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="imagealt" class="form-control" name="imagealt" placeholder="Enter Alt Tag" value="{{ $data['imagealt'] }}" required="">
                              </div>
                           </div>
                           <div class="row">
                              <div class="panel panel-default">
                                 <div class="panel-body">
                                    <!-- //////////////  Section add Side links, testimonial, Preview and Publishstart here  ///////////////// -->
                                    <div class="col-md-6">
                                       <label for="qualification">Expert Qualification</label>
                                       <div class="form-group">
                                          <input list="qualification" class="form-control" name="qualification" placeholder="Enter subject.." value="{{ $data['qualification'] }}" required>
                                    ...
                                    <div class="col-md-6" id="related-question">
                                       <ul class="list-unstyled">
                                          <li style="margin-top: 26px;"><a target="_blank" class="btn btn-primary" style="display: block;" href="#" data-toggle="modal" data-target="#myModal">Add Testimonial</a></li>
                                       </ul>
                                    </div>
                                 </div>
                              </div>
