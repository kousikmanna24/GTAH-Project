                        ...
                        <table id="example0" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example0_info">
                           ...
                           <tr id="tr1" role="row" class="odd">
                              <td  class="sorting_1">{{ $l1->slug }} 
                                 <a href="{{ route('category.create') }}/{{ $l1->id }}" data-toggle="tooltip" title="" data-original-title="Edit category and category name"><i class="fa fa-pencil-square-o"></i></a>
                              </td>
                              <td>{{ $l1->name }}</td>
                              <td>
                              @php
                              ...
                              @foreach($l2cat as $l2)
                                 {{ $l2->slug }}
                                 <a href="{{ route('category.create') }}/{{ $l2->id }}" data-toggle="tooltip" title="" data-original-title="Edit category and category name"><i class="fa fa-pencil-square-o"></i></a>
                                 <br>
                              @endforeach
                              </td>
                              <td>
                              ...
                              @foreach($l3cat as $l3)
                                 {{ $l3->slug }}
                                 <a href="{{ route('category.create') }}/{{ $l3->id }}" data-toggle="tooltip" title="" data-original-title="Edit category and category name"><i class="fa fa-pencil-square-o"></i></a>
                                 <br>
                              @endforeach
                              </td>
                              <td>
