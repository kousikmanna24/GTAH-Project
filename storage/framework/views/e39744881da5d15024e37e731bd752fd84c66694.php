...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
 ...
 <script src="https://www.gotoassignmenthelp.com/admin/ckeditor/ckeditor.js"></script><style>.cke{visibility:hidden;}</style>
...
<div class="dropdown-content">
 ...
 <a href="http://staging.gotoassignmenthelp.com/admin/add-user-rights.php"><span class="icon color6"><!-- <i class="fa fa-user" aria-hidden="true"></i> --></span>User Rights</a>
                
      <a href="http://staging.gotoassignmenthelp.com/admin/user-cms-change-password.php"><span class="icon color6"><!-- <i class="fa fa-lock"></i> --></span>Change Password</a>
  <a href="http://staging.gotoassignmenthelp.com/admin/writer-admin-logout/"><span class="icon color6"><!-- <i class="fa fa-user"></i> --></span>logout</a>
</div>
</div>
</div>
          ...
          <div class="sidebar clearfix">
              <ul class="sidebar-panel nav">
                        ...
                        <li>
                                ...
                                </li><li><a href="http://staging.gotoassignmenthelp.com/admin/add-testimonial.php"><span class="icon color6"><i class="fa fa-tasks" aria-hidden="true"></i></span>Testimonial</a></li>
                                          <li>
...
</div></div></div></body></html><?php /**PATH C:\xampp\htdocs\Laravel Project\Admin_login\resources\views/index.blade.php ENDPATH**/ ?>