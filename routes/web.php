...
//FOR ADMIN LOGIN.........
//login routs
Route::get('login', [beusersController::class, 'login']);
//dashboard routs
Route::get('admin-dashboard', [beusersController::class, 'index']);
//submit login routs
Route::post('login', [beusersController::class, 'submit_login']);
//logout routs
Route::get('logout', [beusersController::class, 'logout']);
