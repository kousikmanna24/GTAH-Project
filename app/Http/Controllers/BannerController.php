...
class BannerController extends Controller
{
    function addBanner(Request $req)
    {
        ...
        return redirect('/view-adding-delete-banner')->with('message','Banner Data Inserted Successfully');
    }
    ...
    function delete($id)
    {
        $data = Banner::find($id);
        $data->delete();
        return redirect('view-adding-delete-banner')->with('message','Banner Data Deleted Successfully');
    }
}
